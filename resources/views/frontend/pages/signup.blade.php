        ...
        <div class="container">
            <form class="maan-signup-signin-form" action="{{ route('signup') }}" method="POST">
                ...
                <div class="maan-input-group">
                    ...
                    <input id="firstName" type="text" name="first_name" class="form-control" placeholder="First Name" value="{{old('first_name')}}">
                    @error('first_name')
                ...
                <div class="maan-input-group">
                    ...
                    <input id="lastName" type="text" name="last_name" class="form-control" placeholder="Last Name" value="{{old('last_name')}}">
                    @error('last_name')
                    <span class="text-danger">
                            {{$message}}
                        </span>
                ...
                <div class="maan-input-group">
                    ...
                    <input id="phoneone" type="number" name="phone" class="form-control" placeholder="Phone"  value="{{old('phone')}}">
                    @error('phone')
                    <span class="text-danger">
                            {{$message}}
                        </span>
                ...
                <div class="maan-input-group">
                    ...
                    <input id="phoneone" type="text" name="email" class="form-control" placeholder="Email" value="{{old('email')}}">
                    @error('email')
                    <span class="text-danger">
                            {{$message}}
                        </span>
                ...
                <div class="maan-input-group">
                    ...
                    <div class="password-area">
                        <input id="passs" type="password" class="form-control" placeholder="Password" name="password_confirmation">
