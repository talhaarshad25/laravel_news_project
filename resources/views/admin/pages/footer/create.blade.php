                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8 co-md-8">
                                                    <select  class="form-control" name="name" id="name" required>
                                                        ...
                                                        <option value="Footer 1" {{ "Footer 1" == old('name') ? 'selected' : '' }}>{{__('Footer 1')}}</option>
                                                        <option value="Footer 2" {{ "Footer 2" == old('name') ? 'selected' : '' }}>{{__('Footer 2')}}</option>
                                                        <option value="Footer 3" {{ "Footer 3" == old('name') ? 'selected' : '' }}>{{__('Footer 3')}}</option>
                                                        <option value="Footer 4" {{ "Footer 4" == old('name') ? 'selected' : '' }}>{{__('Footer 4')}}</option>
                                                        <option value="Footer 5" {{ "Footer 5" == old('name') ? 'selected' : '' }}>{{__('Footer 5')}}</option>
                                                        <option value="Footer 6" {{ "Footer 6" == old('name') ? 'selected' : '' }}>{{__('Footer 6')}}</option>
                                                        <option value="Footer 7" {{ "Footer 7" == old('name') ? 'selected' : '' }}>{{__('Footer 7')}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
