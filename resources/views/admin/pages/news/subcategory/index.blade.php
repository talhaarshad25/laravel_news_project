...
@section('main_content')
    ...
    <div class="content-wrapper" onload="onSubmitInsert()">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        ...
                        <h1>{{ __('News Sub-category') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">{{ __('News Manage') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('News Sub-category') }}</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                            ...
                                            <tr>
                                                ...
                                                <td class="maanaction">
                                                    <div class="row" id="maanaction-in">
                                                        ...
                                                        <form class="archiveItem" action="{{ route('admin.news.subcategory.destroy',$subcategory->id) }}" method="post" >
                                                            @csrf
                                                            @method('delete')
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- form start -->
                <form method="POST" action="{{ route('admin.news.subcategory') }}" enctype="multipart/form-data">
                    @csrf
        ...
        $(document).ready(function (){
            $('.edit-item').each(function () {
                ...
                $('#edit-item_'+service).on('click',function () {
                    ...
                    var editactionroute = "{{ URL::to('admin/news/subcategory/update') }}"
